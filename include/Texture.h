...
class Texture
{
    public:
        ...
        void DrawCircle(SDL_Point ptPoint1, double xRadius, SDL_Color oColor) {SDL_SetRenderDrawColor( oRenderer, oColor.r, oColor.g, oColor.b, oColor.a ); for (double xAngle = 0; xAngle<=2*3.1415;xAngle +=(6.283/120)) {SDL_RenderDrawLine( oRenderer, ptPoint1.x+xRadius*cos(xAngle + (6.283/120)),ptPoint1.y+xRadius*sin(xAngle + (6.283/120)),ptPoint1.x+xRadius*cos(xAngle),ptPoint1.y+xRadius*sin(xAngle));};}
